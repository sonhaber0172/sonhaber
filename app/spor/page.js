...
export async function generateMetadata() {
  return {
    title: 'Spor Haberleri | SonHaber - Son Dakika Spor',
    description: 'Son dakika spor haberleri SonHaber\'de. Futbol, basketbol ve daha fazlası.',
    alternates: { canonical: 'https://sonhaber-rouge.vercel.app/spor' }
  }
}
    ...
    <div style={{background: '#f8f8f8', minHeight: '100vh', display: 'flex', justifyContent: 'center'}}>
      <main style={{width: '100%', maxWidth: '1200px', background: '#ffffff', boxShadow: '0 0 30px rgba(0,0,0,0.08)'}}>
        ...
        <div className="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
          ...
          <h1 className="text-2xl font-black text-gray-900">Spor Haberleri</h1>
