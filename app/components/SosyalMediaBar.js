  ...
  return (
    <div style={{background: '#1a1a2e'}} className="py-4 px-6">
      <div className="flex items-center justify-center gap-4 md:gap-8 flex-wrap">
        ...
        <a href="https://instagram.com/HaberSon0165" target="_blank" rel="noopener noreferrer"
        ...
        <a href="https://twitter.com/HaberSon263775" target="_blank" rel="noopener noreferrer"
        ...
        <a href="https://www.tiktok.com/@HaberSon4" target="_blank" rel="noopener noreferrer"
