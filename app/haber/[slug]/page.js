...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://HaberSon-rouge.vercel.app/haber/${encodeURIComponent(id)}`,
    },
  }
}
...
const altHaberler = siraliHaberler.slice(12, 18)
  ...
  const haberUrl = `https://HaberSon-rouge.vercel.app/haber/${encodeURIComponent(id)}`
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "Ana Sayfa",
      "item": "https://HaberSon-rouge.vercel.app"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": haber.category || "Gündem",
      "item": `https://HaberSon-rouge.vercel.app/?kategori=${encodeURIComponent(haber.category || 'Gündem')}`
    },
    {
      "@type": "ListItem",
      "position": 3,
